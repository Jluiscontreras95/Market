...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'dni' => 'string|required|unique:clients,dni,'.$this->route('client')->id.'|max:8|min:7',
            'rif' => 'string|nullable|unique:clients,ruc,'.$this->route('client')->id.'|max:10|min:8',
            'address' => 'string|nullable|max:255',
            'phone' => 'string|nullable|unique:clients,phone,'.$this->route('client')->id.'|max:11|min:11',
            'email' => 'string|nullable|email:rfc,dns|unique:clients,email,'.$this->route('client')->id.'|max:255',
