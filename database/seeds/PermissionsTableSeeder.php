...
class PermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create([
            'name'          => 'Navegar libro contable',
            'slug'          => 'contabilities.index',
            'description'   => 'Lista y navega todos los usuarios del sistema',
        ]);

        Permission::create([
            'name'          => 'Creación de libro contable',
            'slug'          => 'contabilities.create',
            'description'   => 'Podría crear nuevos usuarios en el sistema',
        ]);

        Permission::create([
            'name'          => 'Ver detalle de libro contable',
            'slug'          => 'contabilities.show',
            'description'   => 'Ve en detalle cada usuario del sistema',            
        ]);
        
        Permission::create([
            'name'          => 'Edición de libro contable',
            'slug'          => 'contabilities.edit',
            'description'   => 'Podría editar cualquier dato de un usuario del sistema',
        ]);
        
        Permission::create([
            'name'          => 'Eliminar libro contable',
            'slug'          => 'contabilities.destroy',
            'description'   => 'Podría eliminar cualquier usuario del sistema',      
        ]);
